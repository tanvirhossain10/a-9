        ...
        <div>
            ...
            <div>
                ...
                <div className="flex justify-center  mb-36 ">
                    {homePageReviews.map(review => <div key={review.id} className='bg-slate-400 p-5 mx-28 text-left drop-shadow-xl shadow-lg shadow-blue-500/50 '><h3 className=' text-3xl p-5'>Name:{review.name}</h3>
                        <p>{review.body}</p>
